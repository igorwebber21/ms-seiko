...
$(function () {
	...
	// from blog carousel
	if ($(".blog-carousel:not(.blog-carousel-another)").length) {
	...
	// from blog carousel 
	if ($(".blog-carousel-another").length) {
		var $this = $(".blog-carousel-another"),
			arrowsplace = $this;
	...
	if ($(".similar-products-carousel").length) {
		var $this = $(".similar-products-carousel"),
			arrowsplace = $this;
	...
	if ($(".viewed-products-carousel").length) {
		var $this = $(".viewed-products-carousel"),
			arrowsplace = $this;
